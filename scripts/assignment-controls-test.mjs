...
const releasePatch = await readFile('scripts/apply-v84-inline-assignment-and-rollover.mjs', 'utf8');
...
assert.match(releasePatch, /copyAccounts:/, 'The release patch must preserve month account setup during rollover.');
