...
assert.match(css, /\.attention-card \.funding-balance-editor input \{[\s\S]*background: var\(--surface-2\);[\s\S]*border-radius: 12px;/s, 'Current balance input must use Penny theme styling.');
