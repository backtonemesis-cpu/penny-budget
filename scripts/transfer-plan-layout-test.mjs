...
assert.ok(main.indexOf("import './overview-compact-v12.css';") < main.indexOf("import './transfer-plan-compact.css';"), 'Transfer-plan CSS must load after Overview CSS so its compact mobile header cannot be overridden.');
